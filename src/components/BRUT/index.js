          ...
          <div className="col-xl-3 col-xxl-4 ">
            <div className="card">
              ...
              <div className="card-body ">
                ...
                <p > <FormattedMessage id="brut.descripcion" defaultMessage={"Traducción pendiente"} /></p>
              </div>
            </div>
          </div>
                ...
                <div className="row sp20 mb-4 align-items-center">
                  <div className="col-lg-4 col-xxl-4 col-sm-4 d-flex flex-wrap align-items-center">
                    <div className="px-2 info-group">
                      <p className="fs-18 mb-1"><FormattedMessage id="brut.precio" defaultMessage={"Traducción pendiente"} /> USDT</p>
                  ...
                  <div className="d-flex col-lg-8 col-xxl-8 col-sm-8 align-items-center mt-sm-0 mt-3 justify-content-end">
                    ...
                    <div className="px-2 info-group">
                      <p className="fs-14 mb-1"><FormattedMessage id="brut.respaldo" defaultMessage={"Traducción pendiente"} /> USDT</p>
                      <h3 className="fs-20 font-w600 text-black">{(this.state.enBrutus * 1).toFixed(2)}</h3>
                    </div>
                    <div className="px-2 info-group">
                      <p className="fs-14 mb-1">BRUT <FormattedMessage id="brut.efectivo" defaultMessage={"Traducción pendiente"} /></p>
                      <h3 className="fs-20 font-w600 text-black">{(this.state.tokensEmitidos * 1).toFixed(2)}</h3>
                    </div>
                    <div className="px-2 info-group">
                      <p className="fs-14 mb-1"><FormattedMessage id="brut.circulando" defaultMessage={"Traducción pendiente"} /></p>
